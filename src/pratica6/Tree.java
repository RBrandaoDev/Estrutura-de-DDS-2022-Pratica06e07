...
class Tree {
	...
	System.out.print("\n Altura da arvore: " + altura(root));
        System.out.print("\n Balance da arvore: " + balance(root));
    ...
    public String balance(No atual){       
        if(altura(atual.esq) == altura(atual.dir))
            return "Arvore balanceada";
        else if (altura(atual.esq) > altura(atual.dir) || altura(atual.dir) > altura(atual.esq) )
            return "Arvore desbalanceada";
        else
